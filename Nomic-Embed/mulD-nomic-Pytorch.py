...
# Training Dataset
    ...
    dataframe_train = pd.read_json('Nomic-Embed/Dataset/muld-data/character_id_train.json', lines=True)
    #dataframe_train = dataframe_train.head(1)

    dataframe_val = pd.read_json('Nomic-Embed/Dataset/muld-data/character_id_validation.json', lines=True)
    #dataframe_val = dataframe_val.head(1)

    dataframe_test = pd.read_json('Nomic-Embed/Dataset/muld-data/character_id_test.json', lines=True)
